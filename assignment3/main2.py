...
with tf.Session() as sess:
    ...
    sess.run(init)
    validate_feed={x:train[:,:56],y_:train[:,56:]}
    ...
    # print test_result
    with open('/home/lee/assignment3/sampleSubmission5.csv', 'w') as csvfile:
        ...
        for i in range(len(test_result)):
            ...
            if test_result[i] == 1:
                writer.writerow([i, 1])
    with open('/home/lee/assignment3/sampleSubmission5.csv', 'r') as csvfile:
